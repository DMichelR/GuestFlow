            ...
            <div className="bg-white shadow-md rounded-lg p-6">
                {userId ? (
                    <div className="space-y-4">
                        <p className="text-lg">
                            You are logged in as <span className="font-semibold">{user?.emailAddresses[0].emailAddress}</span>
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <Link href="/sign-in" className="inline-block bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition">
                            Sign In
                        </Link>
                    </div>
                )}
