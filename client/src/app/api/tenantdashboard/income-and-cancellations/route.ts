// src/app/api/tenantdashboard/income-and-cancellations/route.ts
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}/TenantDashboard/income-and-cancellations?${queryParams}`,
      {
        method: "GET",
        headers: {
    ...
    console.error("Error fetching income and cancellations data:", error);
