// src/app/api/tenantdashboard/analytics/services/route.ts
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}/TenantDashboard/analytics/services?${queryParams}`,
      {
        method: "GET",
        headers: {
    ...
    console.error("Error fetching services analytics data:", error);
