// src/app/api/tenantdashboard/analytics/rooms/route.ts
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}/TenantDashboard/analytics/rooms?${queryParams}`,
      {
        method: "GET",
        headers: {
    ...
    console.error("Error fetching rooms analytics data:", error);
