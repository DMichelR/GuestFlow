// src/app/api/tenantdashboard/occupancy/historical/route.ts
...
export async function GET() {
  ...
  try {
    ...
    const response = await fetch(
      `${API_URL}/TenantDashboard/occupancy/historical`,
      {
        method: "GET",
        headers: {
    ...
    console.error("Error fetching historical occupancy data:", error);
