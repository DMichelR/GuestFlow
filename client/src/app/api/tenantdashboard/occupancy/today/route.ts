// src/app/api/tenantdashboard/occupancy/today/route.ts
...
export async function GET() {
  ...
  try {
    ...
    const response = await fetch(`${API_URL}/TenantDashboard/occupancy/today`, {
      method: "GET",
      headers: {
    ...
    console.error("Error fetching today's occupancy data:", error);
