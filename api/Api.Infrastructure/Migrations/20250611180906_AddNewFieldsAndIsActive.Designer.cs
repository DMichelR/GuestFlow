...
namespace Api.Infrastructure.Migrations
{
    ...
    [Migration("20250611180906_AddNewFieldsAndIsActive")]
    partial class AddNewFieldsAndIsActive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "access_level", new[] { "staff", "receptionist", "manager", "admin" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "room_status", new[] { "available", "occupied", "maintenance", "cleaning", "out_of_order" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "stay_state", new[] { "pending", "active", "completed", "canceled" });
            ...
            modelBuilder.Entity("Api.Domain.Entities.Concretes.UserRelated.User", b =>
                {
                    ...
                    b.Property<AccessLevel>("AccessLevel")
